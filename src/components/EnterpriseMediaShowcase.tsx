...
export function EnterpriseMediaShowcase() {
  ...
  // 3 Domain-Specific Editorial Architectural Pillars for Rightsholders
  const architecturalPillars = [
    {
      id: 'pillar-audit',
      tag: 'Inventory Ingestion',
      title: 'Asset Audit & Fair Market Valuation Agent',
      description:
        'Extracts physical and digital inventory from venue CADs and past contracts, benchmarking fair market value against live sports and entertainment comp indexes.',
    },
    {
      id: 'pillar-deck',
      tag: 'Generative Decks',
      title: 'Automated Pitch Decks & Rate Card Synthesizer',
      description:
        'Synthesizes bespoke, partner-branded presentations with category exclusivity checks and tiered activation bundles in under 5 minutes with user sign-off.',
    },
    {
      id: 'pillar-sla',
      tag: 'Obligation Guard',
      title: 'Contract Handling & Brand Partner Portal',
      description:
        'Translates executed agreements into immutable delivery calendars, tracking live broadcast minutes, VIP suites, and auto-compiling ROI wrap-up reports.',
    },
  ];
          ...
          <div className="relative z-10 w-full p-6 sm:p-10 flex flex-col justify-between gap-8">
            ...
            <div className="flex items-center justify-between">
              <div className="inline-flex items-center gap-2 rounded-full bg-black/75 backdrop-blur-md px-3.5 py-1.5 text-xs font-mono text-white border border-white/20 shadow-lg">
                ...
                <span className="font-semibold tracking-wide" style={{ color: '#ffffff' }}>Live Rightsholder Node</span>
                <span className="text-white/40">|</span>
                <span className="text-slate-300" style={{ color: '#CBD5E1' }}>Stadium Edge #402</span>
              </div>
            ...
            <div className="max-w-2xl rounded-xl bg-black/85 backdrop-blur-md border border-white/20 p-6 sm:p-7 shadow-2xl space-y-3">
              ...
              >
                ...
                Autonomous Commercialization Engine
              </div>
              <h2
                style={{ color: '#ffffff' }}
                className="text-2xl sm:text-3xl lg:text-[32px] font-extrabold tracking-tight !text-white leading-tight drop-shadow-sm"
              >
                Building the commercial &amp; operational infrastructure for {siteConfig.name}.
              </h2>
              <p
                style={{ color: '#E2E8F0' }}
                className="text-xs sm:text-sm !text-slate-200 leading-relaxed font-normal"
              >
                Structured document intake, multi-agent context passing, and automated partner delivery tracking running across world-class stadiums, arenas, and cultural festivals.
              </p>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="max-w-3xl mb-8 sm:mb-10">
            ...
            <h3 className="text-2xl sm:text-3xl font-bold tracking-tight text-[var(--color-text-primary)]">
              Powering commercial operations of all sizes.{' '}
              <span className="text-[var(--color-text-secondary)] opacity-75 font-normal">
                Built for single-property rightsholders up to multi-venue sports &amp; entertainment consortiums.
              </span>
            </h3>
          </div>
          ...
          <div className="rounded-xl border border-[var(--color-border)] bg-[var(--color-surface)] overflow-hidden shadow-2xs hover:shadow-xs transition-shadow mb-8">
            <div className="relative h-64 sm:h-80 w-full overflow-hidden bg-slate-900">
              ...
              <img
                ...
                alt="Modern stadium venue under vibrant sky"
              ...
              <div className="absolute top-4 left-4 flex gap-2">
                ...
                <span className="px-2.5 py-1 rounded-[4px] bg-[#533AFD]/90 text-white backdrop-blur-md text-[10px] font-mono font-semibold">
                  Commercial Consulting Replacement
                </span>
              </div>
            </div>
            ...
            <div className="p-6 sm:p-8 flex flex-col sm:flex-row sm:items-center justify-between gap-6">
              <div className="space-y-1 max-w-2xl">
                <div className="text-base sm:text-lg font-bold text-[var(--color-text-primary)]">
                  Metropolitan Stadium &amp; Entertainment District
                </div>
                <p className="text-xs sm:text-sm text-[var(--color-text-secondary)] opacity-85 leading-relaxed">
                  Eliminated $180K in external agency fees with automated inventory valuation and brand matching, closing $14.2M in annual sponsorships across naming rights and digital displays.
                </p>
              </div>

              <div className="flex items-center gap-6 text-xs font-mono text-[var(--color-text-secondary)] shrink-0">
                <div>
                  <div className="text-lg font-bold text-[var(--color-text-primary)]">99.4%</div>
                  <div className="text-[10px] opacity-75">SLA Delivery</div>
                </div>
                <div className="h-8 w-[1px] bg-[var(--color-border)]" />
                <div>
                  <div className="text-lg font-bold text-[#533AFD] dark:text-[#7A68FF]">4.2x</div>
                  <div className="text-[10px] opacity-75">Deal Velocity</div>
                </div>
              </div>
            </div>
          </div>
